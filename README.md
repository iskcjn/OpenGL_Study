...
- `src/main/java/com/tiangong/blockhorizon/world/chunk`：包含与世界块相关的代码，如 `ChunkRender.java` 文件，其中定义了 `draw`、`cleanUp` 等方法用于图形绘制和资源清理。
...
## 许可证
本项目使用 [MIT 许可证](LICENSE) 进行许可，详情请参阅 `LICENSE` 文件。
